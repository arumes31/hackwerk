...
type Querier interface {
	...
	InsertTransportPartner(ctx context.Context, arg InsertTransportPartnerParams) (string, error)
	...
	ListActiveTransportPartners(ctx context.Context) ([]ListActiveTransportPartnersRow, error)
	...
	LockActiveTransportPartner(ctx context.Context, id pgtype.UUID) (string, error)
